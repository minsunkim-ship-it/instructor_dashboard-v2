...
const COURSE_STOPWORDS = new Set([
  ...
  "사본",
  "ai",
  // v24: 연도 제외 (cross-instructor matching 회귀 차단)
  "2023", "2024", "2025", "2026", "2027", "2028",
  "23년", "24년", "25년", "26년", "27년",
  "23년도", "24년도", "25년도", "26년도",
  // v24: 일반 keyword (generic course terms)
  "b2b", "b2c", "공", "교육", "과정", "기초", "심화", "특강",
  "역량강화", "아카데미", "강의", "워크숍", "워크샵", "코스",
  "기획", "분석", "활용", "실무", "이해", "전문가", "양성",
  "생성형", "리터러시", "literacy", "module", "모듈",
  "1차수", "2차수", "3차수", "4차수", "5차수", "6차수", "7차수", "8차수", "9차수",
  "1일차", "2일차", "3일차", "4일차", "5일차",
  "1회차", "2회차", "3회차", "4회차", "5회차", "6회차", "7회차", "8회차", "9회차",
]);
